...
<form action = "<?php $_SERVER['PHP_SELF']; ?>" method = "post">
	...
	<input type = "text" name = "username" value= "<?php if($_POST["username"]) echo $_POST['first_name']?>"><br/>
	<label>Password </label>
	<input type = "text" name = "password" value= "<?php if($_POST["password"]) echo $_POST['first_name']?>"><br/>
	<label>Confirm Password </label>
	<input type = "text" name = "password2" value= "<?php if($_POST["password2"]) echo $_POST['first_name']?>"><br/>
